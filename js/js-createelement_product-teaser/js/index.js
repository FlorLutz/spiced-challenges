...
const productTwo = document.createElement("article");
productTwo.classList.add("product");
productTwo.innerHTML = `<div class="product__body">
...
document.body.append(productTwo);

const buyButton = document.querySelector('[data-js="buy-button"]');
buyButton.addEventListener("click", () => {
  console.log("productname and price:", name, price);
});
